...
variable "user_public_ip_ankit" {
  description = "Public IP of User Ankit"
  type        = string
  default     = "223.190.92.151/32"
}

variable "user_public_ip_sheetal" {
  description = "Public IP of User Sheetal"
  type        = string
  default     = "112.196.122.18/32"
}

variable "user_public_ip_carlos" {
  description = "Public IP of User Carlos"
  type        = string
  default     = "79.153.80.239/32"
}
